...
void test_validate_my_username()
{
	...
	char *username_from_conf_file;
	// Call the my_username() function in autotest-validate.c to get your hard coded username.
	//username = my_username();
	//Obtain the value returned from function malloc_username_from_conf_file() in username-from-conf-file.h within
	//the assignment autotest submodule at assignment-autotest/test/assignment1/
	//	
	...
	TEST_ASSERT_EQUAL_STRING_MESSAGE(username, username_from_conf_file, "The case Passed" ); 
